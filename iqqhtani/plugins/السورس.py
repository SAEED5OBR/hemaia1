...
IqqhtaniPC = gvarstatus("ALIVE_PIC") or "https://up6.cc/2022/05/165152347887371.jpg"
...
async def _(event):
    ...
    OUTPUT = (f"♛︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس القحطاني @iqqhtani :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث القحطاني انتضر من 5 الى 10 دقائق")
    try:
...
https://t.me/ghtanisaeed/36
  • لتغير صوره او فيديو امر الفحص اضغط هنا ↶
https://t.me/ghtanisaeed/39
  • لتغير كليشة امر حماية الخاص اضغط هنا ↶
https://t.me/ghtanisaeed/35
  • لوضع صوره او فيديو حماية الخاص اضغط هنا ↶
https://t.me/ghtanisaeed/38
  • لتغير عدد تحذيرات حماية الخاص اضغط هنا ↶
https://t.me/ghtanisaeed/45
  • لتغير نبذه الوقتيه اضغط هنا ↶
https://t.me/ghtanisaeed/54
  • لتغير صوره وقتيه اضغط هنا ↶
 https://t.me/ghtanisaeed/46
  • لتغير خط زخرفه اسم وقتي اضغط هنا ↶
 https://t.me/ghtanisaeed/59
  •  لوضع ايموجي بجانب اسم وقتي اضغط هنا ↶
 https://t.me/ghtanisaeed/37
• لتغير امر من الاوامر اضغط هنا ↶
https://t.me/ghtanisaeed/4718
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/ghtanisaeed/51

قناة الكلايش  : @ghtanisaeed
قناه شروحات الاوامر  : @ghtanisaeed
قناه المتغيرات او الفارات : @ghtanisaeed""")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqqhtani(iqqhtani):
        ...
        if query.startswith("تنصيب") and iqqhtani.query.user_id == bot.uid:
            buttons = [[Button.url("1- قناة السورس ", "https://t.me/ghtanisaeed"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethonAr/CodeTermex?lite=1&outputonly=1#main.py"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/SAEED5OBR/hemaia"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/SAEED5OBR"),]]
...
♛  اوامر الملصقات ↢ ( .م16 )
———————×———————
شرح الأوامر : ( @ghtanisaeed ) .
قناه السورس : ( @Iqqhtani ) .
...
( .ايقاف اسم وقتي )
———————×———————
 ♛︙ يوجد شرح مفصل عن الامر هنا : https://t.me/ghtanisaeed/4484
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط القروب يضيفهم بقروبك
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/ghtanisaeed/4483
شرح الأوامر : ( @ghtanisaeed ) .
قناه السورس : ( @Iqqhtani ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/ghtanisaeed/4704
قناه السورس : ( @Iqqhtani ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/ghtanisaeed/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/ghtanisaeed/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/ghtanisaeed/4720  ⦒
""")
...
———————×———————
الأمر ⦙ ( .المده )
الشرح  : يضهر لك مدة تشغيل بوت القحطاني لديك
———————×———————
الأمر ⦙ ( .تحميل ملف + الرد ع الملف )
الشرح : يحمل ملفات القحطاني
———————×———————
الأمر ⦙ ( .مسح ملف + الرد ع الملف )
الشرح :  يمسح الملف الي حملته
———————×———————
الأمر ⦙ ( .تحديث )
الشرح :  امر لأعاده التشغيل وتحديث ملفات السورس وتسريع الالقحطاني
———————×———————
الأمر ⦙ ( .اطفاء مؤقت + عدد الثواني )
الشرح : يقوم بأطفاء الالقحطاني بعدد الثواني الي ضفتها  عندما تخلص الثواني سيتم اعاده تشغيل الالقحطاني
———————×———————
الأمر ⦙ ( .الاوامر )
...
———————×———————
الأمر ⦙ ( .استخدامي )
الشرح :   يضهر لك كمية استخدامك لالقحطاني
———————×———————
الأمر ⦙ ( .تاريخ التنصيب )
...
الشرح : اي شخص يعملك تاك او يراسلك او يرد عليك يرد عليه القحطاني بكليشة انا حاليا غير موجود ويضع له السبب الي نتة وضعته
———×———
...
(.ص70) ⦙  بسبوس
(.ص71) ⦙  اني بتيتة دبة
(.ص72) ⦙  الله ياخذكم وياخذ اللي يلعب معاكم كوره
(.ص73) ⦙  انت شدخلك
(.ص74) ⦙  انا ماشي بطلع
