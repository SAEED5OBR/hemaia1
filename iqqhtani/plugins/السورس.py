...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqqhtani(iqqhtani):
        ...
        if query.startswith("تنصيب") and iqqhtani.query.user_id == bot.uid:
            buttons = [[Button.url("1- قناة السورس ", "https://t.me/ghtanisaeed"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- كود تيرميكس", "https://replit.com/@telethonArab/CodeTelethon"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/SAEED5OBR/hemaia"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/SAEED5OBR"),]]
