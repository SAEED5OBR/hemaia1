...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "تخزين تليثون العرب العام", iqqhtani, Config.TG_BOT_USERNAME, descript        )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين تليثون العرب الخاص", iqqhtani, Config.TG_BOT_USERNAME, descript        )
